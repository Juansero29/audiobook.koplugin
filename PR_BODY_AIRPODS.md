...
- Companion Storyteller UX (same field device): mini-player **page-margin reserve** so read-aloud chrome never covers book text when status/progress bars stay visible (v0.1.17.23; see Storyteller PR)
