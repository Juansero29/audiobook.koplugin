...
FR_FIX: dict[str, str] = {
    ...
    "Built-in audiobook: %1 sentences, %2 chapters": "Livre audio intégré : %1 phrases, %2 chapitres",
    "Keep the audiobook bar": "Conserver la barre du livre audio",
    "Highlight sync": "Synchronisation du surlignage",
    "Highlight sync: %1 s": "Synchronisation du surlignage : %1 s",
...
ES_FIX: dict[str, str] = {
    ...
    "Built-in audiobook: %1 sentences, %2 chapters": "Audiolibro integrado: %1 frases, %2 capítulos",
    "Keep the audiobook bar": "Conservar la barra del audiolibro",
    "Highlight sync": "Sincronización del resaltado",
    "Highlight sync: %1 s": "Sincronización del resaltado: %1 s",
